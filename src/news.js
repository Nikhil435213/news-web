...
class News extends React.Component {
    constructor(props) {
      ...
      this.state = { name1: <h1 style={{color:"red"}}>Loading ! please wait...</h1>,count:0 };
        ...
        return (
          ...
          <div class="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 pt-4 pb-2">
              ...
              <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Nikhil</span>
